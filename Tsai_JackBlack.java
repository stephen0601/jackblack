...
public class Tsai_JackBlack {
	...
	static int dealerCounter = 0 ; 
	static int numHands = 1 ; 
	...
	public static void main(String[] args) {
		...
		while (numInput == 1 ) {
			...
			System.out.println( "Would you like to continue playing? Type 0 for no or 1 for yes.");
